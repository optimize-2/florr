package cn.optimize_2.client.ui.clickable;

import cn.optimize_2.client.Client;
import cn.optimize_2.client.Florr;
import cn.optimize_2.client.ui.RenderEntity;
import org.lwjgl.BufferUtils;
import cn.optimize_2.utils.input.InputHandler;
import cn.optimize_2.utils.render.MouseBounds;
...
public class ClickEntity extends RenderEntity {
    ...
    public ClickEntity(double x, double y, double x1, double y1, Runnable click,
            Runnable hold,
            Runnable focus, Runnable release, Runnable onBlur) {
        this.clicktick = this.isLeftDown() ? 999 : 0;
        this.mousebounds = new MouseBounds(getMouseX(), getMouseY(), x, y, x1, y1);
        this.click = click;
        this.hold = hold;
        this.focus = focus;
    ...
    public boolean isLeftDown() {
        return InputHandler.mouseButtonDown(0);
    }

    public boolean isRightDown() {
        return InputHandler.mouseButtonDown(1);
    }

    public boolean isMiddleDown() {
        return InputHandler.mouseButtonDown(2);
    }
    ...
    public double getMouseX() {
        ...
        glfwGetCursorPos(Client.game.window.windowHandle, xBuffer, yBuffer);
    ...
    public double getMouseY() {
        ...
        return ((double) Florr.getGameHeight() - y);
    }
