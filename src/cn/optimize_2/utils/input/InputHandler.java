package cn.optimize_2.utils.input;
...
public class InputHandler {
    ...
    public static ArrayList<InputBox> inputBoxes = new ArrayList<>();
    ...
    public static GLFWCharCallback input = new GLFWCharCallback() {
        @Override
        public void invoke(long window, int codepoint) {
            for (InputBox i : inputBoxes) {
                i.keyTyped(codepoint);
            }
        }
    };
